const projectsData = [
    {
        id: 1,
        gif: require('../assets/images/fabric-preview.gif'),
        title: 'ФАБРИКА ДЕРЕВЯННЫХ ИГРУШЕК',    
        description: 'Брендинг, упаковка, мерч, сувенирка, SMM',
        link: "ToysFactory",
    },
    // {
    //     id: 2,
    //     gif: require('../assets/images/muithom-preview.gif'),
    //     title: 'MuiThom',    
